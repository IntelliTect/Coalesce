...
* **Code Generation** Write your data model. We'll build the DTOs, API controllers, and TypeScript that are needed to start building a front-end UI right away. A full suite of CRUD endpoints are created for you with inner-workings that are overridable to great degrees.
