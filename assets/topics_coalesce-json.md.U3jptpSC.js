...
<span class="line"><span style="color:#D4D4D4;">    },</span></span>
<span class="line"></span>
<span class="line"><span style="color:#6A9955;">    // The name of the root generator to use. Defaults to &quot;Knockout&quot;.</span></span>
<span class="line"><span style="color:#6A9955;">    // Available values are &quot;Vue&quot; and &quot;Knockout&quot;.</span></span>
...
<span class="line"><span style="color:#6A9955;">        // For example, &quot;Views&quot; or &quot;IntelliTect.Coalesce.CodeGeneration.Knockout.Generators.Views&quot;.</span></span>
...
<span class="line"><span style="color:#D4D4D4;">        },</span></span>
<span class="line"><span style="color:#6A9955;">        // Indentation for generated C# is configurable by type (API controllers, DTO classes and regular View controllers)</span></span>
<span class="line"><span style="color:#6A9955;">        // It defaults to 4 spaces</span></span>
<span class="line"><span style="color:#CE9178;">        &quot;ApiController&quot;</span><span style="color:#9CDCFE;">:</span><span style="color:#D4D4D4;"> {</span></span>
<span class="line"><span style="color:#CE9178;">            &quot;indentationSize&quot;</span><span style="color:#9CDCFE;">:</span><span style="color:#B5CEA8;"> 2</span><span style="color:#D4D4D4;"> </span></span>
<span class="line"><span style="color:#D4D4D4;">        },</span></span>
<span class="line"><span style="color:#CE9178;">        &quot;ClassDto&quot;</span><span style="color:#9CDCFE;">:</span><span style="color:#D4D4D4;"> {</span></span>
<span class="line"><span style="color:#CE9178;">            &quot;indentationSize&quot;</span><span style="color:#9CDCFE;">:</span><span style="color:#B5CEA8;"> 2</span><span style="color:#D4D4D4;"> </span></span>
<span class="line"><span style="color:#D4D4D4;">        },</span></span>
<span class="line"><span style="color:#CE9178;">        &quot;ViewController&quot;</span><span style="color:#9CDCFE;"> :</span><span style="color:#D4D4D4;"> {</span></span>
<span class="line"><span style="color:#CE9178;">            &quot;indentationSize&quot;</span><span style="color:#9CDCFE;">:</span><span style="color:#B5CEA8;"> 2</span></span>
<span class="line"><span style="color:#D4D4D4;">        }</span></span>
<span class="line"><span style="color:#D4D4D4;">    }</span></span>
<span class="line"><span style="color:#D4D4D4;">}</span></span></code></pre></div><h2 id="additional-cli-options" tabindex="-1">Additional CLI Options <a class="header-anchor" href="#additional-cli-options" aria-label="Permalink to &quot;Additional CLI Options&quot;">​</a></h2><p>There are a couple of extra options which are only available as CLI parameters to <code>dotnet coalesce</code>. These options do not affect the behavior of the code generation - only the behavior of the CLI itself.</p><p><code>--debug</code></p><p>When this flag is specified when running <code>dotnet coalesce</code>, Coalesce will wait up to 60 seconds for a debugger to be attached to its process before starting code generation.</p><p><code>-v|--verbosity &lt;level&gt;</code></p><p>Set the verbosity of the output. Options are <code>trace</code>, <code>debug</code>, <code>information</code>, <code>warning</code>, <code>error</code>, <code>critical</code>, and <code>none</code>.</p>`,14),t=[l];function p(c,i,r,u,d,y){return n(),a("div",null,t)}const C=s(o,[["render",p]]);export{f as __pageData,C as default};
