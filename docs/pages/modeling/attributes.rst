...
The displayed name name of a property can also be set via the :csharp:`[DisplayName]` attribute.

Required
........

Properties with :csharp:`[Required]` will generate Knockout-Validation_ extenders. See :ref:`ClientValidation`.

Range
.....

Properties with :csharp:`[Range]` will generate Knockout-Validation_ extenders. See :ref:`ClientValidation`.

MinLength
.........

Properties with :csharp:`[MinLength]` will generate Knockout-Validation_ extenders. See :ref:`ClientValidation`.

MaxLength
.........

Properties with :csharp:`[MaxLength]` will generate Knockout-Validation_ extenders. See :ref:`ClientValidation`.
