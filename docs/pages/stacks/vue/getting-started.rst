...
.. note::
  ...
  For simple property types like :ts:`string` and :ts:`number` you can always use simple template interpolation syntax, but for more complex properties like dates, :ref:`c-display` is handy to use because it includes features like built-in date formatting.
