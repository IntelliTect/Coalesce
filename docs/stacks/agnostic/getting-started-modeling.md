...
At this point, you can run your new application. However, your application won't do much without a data model, so you will probably want to do the following:
...
- Run ``dotnet ef migrations add Init`` (Init can be any name) in the Migrations project to create an initial database migration.
