...
namespace Coalesce.Web.Ko.Models
{
    ...
    public partial class AuditLogResponse : GeneratedResponseDto<Coalesce.Domain.AuditLog>
    {
        ...
        public Coalesce.Web.Ko.Models.PersonResponse User { get; set; }
        public System.Collections.Generic.ICollection<Coalesce.Web.Ko.Models.AuditLogPropertyResponse> Properties { get; set; }
