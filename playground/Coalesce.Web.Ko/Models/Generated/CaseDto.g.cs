...
namespace Coalesce.Web.Ko.Models
{
    ...
    public partial class CaseResponse : GeneratedResponseDto<Coalesce.Domain.Case>
    {
        ...
        public Coalesce.Web.Ko.Models.PersonResponse AssignedTo { get; set; }
        public Coalesce.Web.Ko.Models.PersonResponse ReportedBy { get; set; }
        public System.Collections.Generic.ICollection<Coalesce.Web.Ko.Models.CaseProductResponse> CaseProducts { get; set; }
        public Coalesce.Web.Ko.Models.DevTeamResponse DevTeamAssigned { get; set; }
