...
namespace Coalesce.Web.Ko.Models
{
    ...
    public partial class PersonResponse : GeneratedResponseDto<Coalesce.Domain.Person>
    {
        ...
        public System.Collections.Generic.ICollection<Coalesce.Web.Ko.Models.CaseResponse> CasesAssigned { get; set; }
        public System.Collections.Generic.ICollection<Coalesce.Web.Ko.Models.CaseResponse> CasesReported { get; set; }
        public Coalesce.Web.Ko.Models.PersonStatsResponse PersonStats { get; set; }
        public Coalesce.Web.Ko.Models.CompanyResponse Company { get; set; }
