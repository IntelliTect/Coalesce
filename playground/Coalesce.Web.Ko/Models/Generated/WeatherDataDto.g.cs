...
namespace Coalesce.Web.Ko.Models
{
    public partial class WeatherDataParameter : GeneratedParameterDto<Coalesce.Domain.Services.WeatherData>
    {
        ...
        private Coalesce.Web.Ko.Models.LocationParameter _Location;
        ...
        public Coalesce.Web.Ko.Models.LocationParameter Location
        {
            get => _Location;
    ...
    public partial class WeatherDataResponse : GeneratedResponseDto<Coalesce.Domain.Services.WeatherData>
    {
        ...
        public Coalesce.Web.Ko.Models.LocationResponse Location { get; set; }
