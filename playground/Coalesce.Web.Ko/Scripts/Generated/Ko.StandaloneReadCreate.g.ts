...
module ViewModels {
    ...
    export class StandaloneReadCreate extends Coalesce.BaseViewModel {
        public readonly modelName = "StandaloneReadCreate";
        public readonly primaryKeyName = "id";
        public readonly modelDisplayName = "Standalone Read Create";
        public readonly apiController = "/StandaloneReadCreate";
        public readonly viewController = "/StandaloneReadCreate";
        
        /** Configuration for all instances of StandaloneReadCreate. Can be overidden on each instance via instance.coalesceConfig. */
        public static coalesceConfig: Coalesce.ViewModelConfiguration<StandaloneReadCreate>
            = new Coalesce.ViewModelConfiguration<StandaloneReadCreate>(Coalesce.GlobalConfiguration.viewModel);
        
        /** Configuration for the current StandaloneReadCreate instance. */
        public coalesceConfig: Coalesce.ViewModelConfiguration<this>
            = new Coalesce.ViewModelConfiguration<StandaloneReadCreate>(StandaloneReadCreate.coalesceConfig);
        
        /** The namespace containing all possible values of this.dataSource. */
        public dataSources: typeof ListViewModels.StandaloneReadCreateDataSources = ListViewModels.StandaloneReadCreateDataSources;
        ...
        */
        ...
        constructor(newItem?: object, parent?: Coalesce.BaseViewModel | ListViewModels.StandaloneReadCreateList) {
            super(parent);
            this.baseInitialize();
            const self = this;
