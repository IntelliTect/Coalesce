...
namespace Coalesce.Web.Vue2.Models
{
    ...
    public partial class CaseResponse : GeneratedResponseDto<Coalesce.Domain.Case>
    {
        ...
        public Coalesce.Web.Vue2.Models.PersonResponse ReportedBy { get; set; }
        public System.Collections.Generic.ICollection<Coalesce.Web.Vue2.Models.CaseProductResponse> CaseProducts { get; set; }
        public Coalesce.Web.Vue2.Models.DevTeamResponse DevTeamAssigned { get; set; }
