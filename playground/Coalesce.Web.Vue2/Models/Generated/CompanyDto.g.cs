...
namespace Coalesce.Web.Vue2.Models
{
    ...
    public partial class CompanyResponse : GeneratedResponseDto<Coalesce.Domain.Company>
    {
        ...
        public System.Collections.Generic.ICollection<Coalesce.Web.Vue2.Models.PersonResponse> Employees { get; set; }
        ...
        public override void MapFrom(Coalesce.Domain.Company obj, IMappingContext context, IncludeTree tree = null)
        {
            ...
            if (propValEmployees != null && (tree == null || tree[nameof(this.Employees)] != null))
            {
                this.Employees = propValEmployees
                    ...
                    .Select(f => f.MapToDto<Coalesce.Domain.Person, PersonResponse>(context, tree?[nameof(this.Employees)])).ToList();
            }
            else if (propValEmployees == null && tree?[nameof(this.Employees)] != null)
            {
                this.Employees = new PersonResponse[0];
            }
