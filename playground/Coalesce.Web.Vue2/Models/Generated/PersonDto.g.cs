...
namespace Coalesce.Web.Vue2.Models
{
    ...
    public partial class PersonResponse : GeneratedResponseDto<Coalesce.Domain.Person>
    {
        ...
        public System.Collections.Generic.ICollection<Coalesce.Web.Vue2.Models.CaseResponse> CasesAssigned { get; set; }
        public System.Collections.Generic.ICollection<Coalesce.Web.Vue2.Models.CaseResponse> CasesReported { get; set; }
        public Coalesce.Web.Vue2.Models.PersonStatsResponse PersonStats { get; set; }
        public Coalesce.Web.Vue2.Models.CompanyResponse Company { get; set; }
