...
namespace Coalesce.Web.Vue2.Models
{
    public partial class ProductDetailsDtoGen : GeneratedDto<Coalesce.Domain.ProductDetails>
    {
        ...
        private Coalesce.Web.Vue2.Models.StreetAddressDtoGen _ManufacturingAddress;
        private Coalesce.Web.Vue2.Models.StreetAddressDtoGen _CompanyHqAddress;

        public Coalesce.Web.Vue2.Models.StreetAddressDtoGen ManufacturingAddress
        {
            get => _ManufacturingAddress;
            set { _ManufacturingAddress = value; Changed(nameof(ManufacturingAddress)); }
        }
        public Coalesce.Web.Vue2.Models.StreetAddressDtoGen CompanyHqAddress
        {
        ...
        public override void MapTo(Coalesce.Domain.ProductDetails entity, IMappingContext context)
        {
            ...
            if (ShouldMapTo(nameof(ManufacturingAddress))) entity.ManufacturingAddress = ManufacturingAddress?.MapToModel<Coalesce.Domain.StreetAddress, Coalesce.Web.Vue2.Models.StreetAddressDtoGen>(entity.ManufacturingAddress ?? new Coalesce.Domain.StreetAddress(), context);
            if (ShouldMapTo(nameof(CompanyHqAddress))) entity.CompanyHqAddress = CompanyHqAddress?.MapToModel<Coalesce.Domain.StreetAddress, Coalesce.Web.Vue2.Models.StreetAddressDtoGen>(entity.CompanyHqAddress ?? new Coalesce.Domain.StreetAddress(), context);
        }
    }
}
