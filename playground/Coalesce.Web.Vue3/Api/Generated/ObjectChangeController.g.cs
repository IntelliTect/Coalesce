...
namespace Coalesce.Web.Vue3.Api
{
        ...
        : BaseApiController<Coalesce.Domain.ObjectChange, ObjectChangeDtoGen, Coalesce.Domain.AppDbContext>
    {
        ...
        [HttpPost("save")]
        [Authorize]
        public virtual Task<ItemResult<ObjectChangeDtoGen>> Save(
            [FromForm] ObjectChangeDtoGen dto,
            [FromQuery] DataSourceParameters parameters,
            IDataSource<Coalesce.Domain.ObjectChange> dataSource,
            IBehaviors<Coalesce.Domain.ObjectChange> behaviors)
        ...
        [HttpPost("delete/{id}")]
        [Authorize]
        public virtual Task<ItemResult<ObjectChangeDtoGen>> Delete(
            long id,
            IBehaviors<Coalesce.Domain.ObjectChange> behaviors,
            IDataSource<Coalesce.Domain.ObjectChange> dataSource)
