...
namespace Coalesce.Web.Vue3.Models
{
    public partial class WeatherDataDtoGen : GeneratedDto<Coalesce.Domain.Services.WeatherData>
    {
        ...
        private Coalesce.Web.Vue3.Models.LocationDtoGen _Location;
        ...
        public Coalesce.Web.Vue3.Models.LocationDtoGen Location
        {
            get => _Location;
        ...
        public override void MapTo(Coalesce.Domain.Services.WeatherData entity, IMappingContext context)
        {
            ...
            if (ShouldMapTo(nameof(Location))) entity.Location = Location?.MapToModel<Coalesce.Domain.Services.Location, Coalesce.Web.Vue3.Models.LocationDtoGen>(entity.Location ?? new Coalesce.Domain.Services.Location(), context);
        }
    }
}
