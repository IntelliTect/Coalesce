...
import {
  ...
  type DeepPartial,
  defineProps,
  createAbstractProxyViewModelType,
} from "coalesce-vue/lib/viewmodel";

export type AbstractClassViewModel = AbstractClassImplViewModel;
export const AbstractClassViewModel = createAbstractProxyViewModelType<
  $models.AbstractClass,
  AbstractClassViewModel
>($metadata.AbstractClass, $apiClients.AbstractClassApiClient);

export class AbstractClassListViewModel extends ListViewModel<
  $models.AbstractClass,
  $apiClients.AbstractClassApiClient,
  AbstractClassViewModel
> {
  public get getCount() {
  ...
  public get echoAbstractModel() {
    ...
    Object.defineProperty(this, "echoAbstractModel", {
      value: echoAbstractModel,
    });
...
export interface AbstractClassImplViewModel extends $models.AbstractClassImpl {
  ...
  get abstractModelPeople(): ViewModelCollection<
    AbstractClassPersonViewModel,
    $models.AbstractClassPerson
  >;
  set abstractModelPeople(
    value: (AbstractClassPersonViewModel | $models.AbstractClassPerson)[] | null
  );
}
export class AbstractClassImplViewModel
  extends ViewModel<
    $models.AbstractClassImpl,
    $apiClients.AbstractClassImplApiClient,
    number
  >
  implements $models.AbstractClassImpl
{
  public addToAbstractModelPeople(
    initialData?: DeepPartial<$models.AbstractClassPerson> | null
  ) {
    return this.$addChild(
      "abstractModelPeople",
      initialData
    ) as AbstractClassPersonViewModel;
  }

  get people(): ReadonlyArray<PersonViewModel> {
    return (this.abstractModelPeople || [])
      .map(($) => $.person!)
      .filter(($) => $);
  }
  ...
  constructor(initialData?: DeepPartial<$models.AbstractClassImpl> | null) {
    super(
      $metadata.AbstractClassImpl,
      new $apiClients.AbstractClassImplApiClient(),
      initialData
    );
  }
}
...
export class AbstractClassImplListViewModel extends ListViewModel<
  $models.AbstractClassImpl,
  $apiClients.AbstractClassImplApiClient,
  AbstractClassImplViewModel
> {
  public get getCount() {
    const getCount = this.$apiClient.$makeCaller(
      this.$metadata.methods.getCount,
...
export interface AbstractClassPersonViewModel
  extends $models.AbstractClassPerson {
  id: number | null;
  ...
  set abstractClass(
    value: AbstractClassViewModel | $models.AbstractClass | null
  );
}
export class AbstractClassPersonViewModel
  extends ViewModel<
    $models.AbstractClassPerson,
    $apiClients.AbstractClassPersonApiClient,
    number
  >
  implements $models.AbstractClassPerson
{
  constructor(initialData?: DeepPartial<$models.AbstractClassPerson> | null) {
    super(
      $metadata.AbstractClassPerson,
      new $apiClients.AbstractClassPersonApiClient(),
      initialData
    );
  }
}
...
export class AbstractClassPersonListViewModel extends ListViewModel<
  $models.AbstractClassPerson,
  $apiClients.AbstractClassPersonApiClient,
  AbstractClassPersonViewModel
> {
...
export interface AuditLogViewModel extends $models.AuditLog {
  ...
  date: Date | null;
  get properties(): ViewModelCollection<
    AuditLogPropertyViewModel,
    $models.AuditLogProperty
  >;
  set properties(
    value: (AuditLogPropertyViewModel | $models.AuditLogProperty)[] | null
  );
...
export class AuditLogViewModel
  extends ViewModel<$models.AuditLog, $apiClients.AuditLogApiClient, number>
  implements $models.AuditLog
{
  public addToProperties(
    initialData?: DeepPartial<$models.AuditLogProperty> | null
  ) {
    return this.$addChild(
      "properties",
      initialData
    ) as AuditLogPropertyViewModel;
  }
...
export class AuditLogListViewModel extends ListViewModel<
  $models.AuditLog,
  $apiClients.AuditLogApiClient,
  AuditLogViewModel
> {
  constructor() {
...
export class AuditLogPropertyViewModel
  extends ViewModel<
    $models.AuditLogProperty,
    $apiClients.AuditLogPropertyApiClient,
    number
  >
  implements $models.AuditLogProperty
{
  constructor(initialData?: DeepPartial<$models.AuditLogProperty> | null) {
    super(
      $metadata.AuditLogProperty,
      new $apiClients.AuditLogPropertyApiClient(),
      initialData
    );
  }
}
...
export class AuditLogPropertyListViewModel extends ListViewModel<
  $models.AuditLogProperty,
  $apiClients.AuditLogPropertyApiClient,
  AuditLogPropertyViewModel
> {
...
export class BaseClassViewModel
  extends ViewModel<$models.BaseClass, $apiClients.BaseClassApiClient, number>
  implements $models.BaseClass
{
  constructor(initialData?: DeepPartial<$models.BaseClass> | null) {
    super(
      $metadata.BaseClass,
      new $apiClients.BaseClassApiClient(),
      initialData
    );
  }
}
...
export class BaseClassListViewModel extends ListViewModel<
  $models.BaseClass,
  $apiClients.BaseClassApiClient,
  BaseClassViewModel
> {
  constructor() {
...
export class BaseClassDerivedViewModel
  extends ViewModel<
    $models.BaseClassDerived,
    $apiClients.BaseClassDerivedApiClient,
    number
  >
  implements $models.BaseClassDerived
{
  constructor(initialData?: DeepPartial<$models.BaseClassDerived> | null) {
    super(
      $metadata.BaseClassDerived,
      new $apiClients.BaseClassDerivedApiClient(),
      initialData
    );
  }
}
...
export class BaseClassDerivedListViewModel extends ListViewModel<
  $models.BaseClassDerived,
  $apiClients.BaseClassDerivedApiClient,
  BaseClassDerivedViewModel
> {
  constructor() {
    super(
      $metadata.BaseClassDerived,
...
export interface CaseViewModel extends $models.Case {
  ...
  get caseProducts(): ViewModelCollection<
    CaseProductViewModel,
    $models.CaseProduct
  >;
  set caseProducts(
    value: (CaseProductViewModel | $models.CaseProduct)[] | null
  );
...
export class CaseViewModel
  extends ViewModel<$models.Case, $apiClients.CaseApiClient, number>
  implements $models.Case
{
  ...
  public addToCaseProducts(
    initialData?: DeepPartial<$models.CaseProduct> | null
  ) {
  ...
  public get uploadAndDownload() {
    ...
    Object.defineProperty(this, "uploadAndDownload", {
  ...
  public get uploadByteArray() {
    const uploadByteArray = this.$apiClient.$makeCaller(
      ...
      (c, file: string | Uint8Array | null) =>
        c.uploadByteArray(this.$primaryKey, file),
...
export class CaseListViewModel extends ListViewModel<
  $models.Case,
  $apiClients.CaseApiClient,
  CaseViewModel
> {
  static DataSources = $models.Case.DataSources;
  ...
  public get getAllOpenCasesCount() {
    ...
    Object.defineProperty(this, "getAllOpenCasesCount", {
      value: getAllOpenCasesCount,
    });
  ...
  public get randomizeDatesAndStatus() {
    ...
    Object.defineProperty(this, "randomizeDatesAndStatus", {
      value: randomizeDatesAndStatus,
    });
...
export class CaseDtoViewModel
  extends ViewModel<$models.CaseDto, $apiClients.CaseDtoApiClient, number>
  implements $models.CaseDto
{
  ...
  public get asyncMethodOnIClassDto() {
    const asyncMethodOnIClassDto = this.$apiClient.$makeCaller(
      ...
      (c, input: string | null) =>
        c.asyncMethodOnIClassDto(this.$primaryKey, input),
      () => ({ input: null as string | null }),
      (c, args) => c.asyncMethodOnIClassDto(this.$primaryKey, args.input)
    );

    Object.defineProperty(this, "asyncMethodOnIClassDto", {
      value: asyncMethodOnIClassDto,
    });
...
export class CaseDtoListViewModel extends ListViewModel<
  $models.CaseDto,
  $apiClients.CaseDtoApiClient,
  CaseDtoViewModel
> {
  static DataSources = $models.CaseDto.DataSources;
...
export class CaseDtoStandaloneViewModel
  extends ViewModel<
    $models.CaseDtoStandalone,
    $apiClients.CaseDtoStandaloneApiClient,
    number
  >
  implements $models.CaseDtoStandalone
{
  constructor(initialData?: DeepPartial<$models.CaseDtoStandalone> | null) {
    super(
      $metadata.CaseDtoStandalone,
      new $apiClients.CaseDtoStandaloneApiClient(),
      initialData
    );
    this.$saveMode = "whole";
  }
...
export class CaseDtoStandaloneListViewModel extends ListViewModel<
  $models.CaseDtoStandalone,
  $apiClients.CaseDtoStandaloneApiClient,
  CaseDtoStandaloneViewModel
> {
  constructor() {
    super(
      $metadata.CaseDtoStandalone,
...
export class CaseProductViewModel
  extends ViewModel<
    $models.CaseProduct,
    $apiClients.CaseProductApiClient,
    number
  >
  implements $models.CaseProduct
{
  constructor(initialData?: DeepPartial<$models.CaseProduct> | null) {
    super(
      $metadata.CaseProduct,
      new $apiClients.CaseProductApiClient(),
      initialData
    );
  }
}
...
export class CaseProductListViewModel extends ListViewModel<
  $models.CaseProduct,
  $apiClients.CaseProductApiClient,
  CaseProductViewModel
> {
...
export class CaseStandaloneViewModel
  extends ViewModel<
    $models.CaseStandalone,
    $apiClients.CaseStandaloneApiClient,
    number
  >
  implements $models.CaseStandalone
{
  static DataSources = $models.CaseStandalone.DataSources;

  constructor(initialData?: DeepPartial<$models.CaseStandalone> | null) {
    super(
      $metadata.CaseStandalone,
      new $apiClients.CaseStandaloneApiClient(),
      initialData
    );
  }
}
...
export class CaseStandaloneListViewModel extends ListViewModel<
  $models.CaseStandalone,
  $apiClients.CaseStandaloneApiClient,
  CaseStandaloneViewModel
> {
  static DataSources = $models.CaseStandalone.DataSources;
...
export class CompanyViewModel
  extends ViewModel<$models.Company, $apiClients.CompanyApiClient, number>
  implements $models.Company
{
  ...
  public get conflictingParameterNames() {
    const conflictingParameterNames = this.$apiClient.$makeCaller(
      ...
      (c, companyParam: $models.Company | null, name: string | null) =>
        c.conflictingParameterNames(this.$primaryKey, companyParam, name),
      () => ({
        companyParam: null as $models.Company | null,
        name: null as string | null,
      }),
      (c, args) =>
        c.conflictingParameterNames(
          this.$primaryKey,
          args.companyParam,
          args.name
        )
    ...
    Object.defineProperty(this, "conflictingParameterNames", {
      value: conflictingParameterNames,
    });
...
export class CompanyListViewModel extends ListViewModel<
  $models.Company,
  $apiClients.CompanyApiClient,
  CompanyViewModel
> {
  static DataSources = $models.Company.DataSources;
...
export class LogViewModel
  extends ViewModel<$models.Log, $apiClients.LogApiClient, number>
  implements $models.Log
{
...
export class LogListViewModel extends ListViewModel<
  $models.Log,
  $apiClients.LogApiClient,
  LogViewModel
> {
  constructor() {
...
export class PersonViewModel
  extends ViewModel<$models.Person, $apiClients.PersonApiClient, number>
  implements $models.Person
{
  ...
  public get changeSpacesToDashesInName() {
    ...
    Object.defineProperty(this, "changeSpacesToDashesInName", {
      value: changeSpacesToDashesInName,
    });
  ...
  public get setBirthDate() {
    const setBirthDate = this.$apiClient.$makeCaller(
      ...
      (c, date?: Date | null, time?: Date | null) =>
        c.setBirthDate(this.$primaryKey, date, time),
  ...
  public get changeFirstName() {
    const changeFirstName = this.$apiClient.$makeCaller(
      ...
      (c, firstName: string | null, title?: $models.Titles | null) =>
        c.changeFirstName(this.$primaryKey, firstName, title),
      () => ({
        firstName: null as string | null,
        title: null as $models.Titles | null,
      }),
      (c, args) =>
        c.changeFirstName(this.$primaryKey, args.firstName, args.title)
    );
...
export class PersonListViewModel extends ListViewModel<
  $models.Person,
  $apiClients.PersonApiClient,
  PersonViewModel
> {
  static DataSources = $models.Person.DataSources;
  ...
  */
  public get add() {
    const add = this.$apiClient.$makeCaller(
      ...
      (c, numberOne?: number | null, numberTwo?: number | null) =>
        c.add(numberOne, numberTwo),
      () => ({
        numberOne: null as number | null,
        numberTwo: null as number | null,
      }),
  ...
  public get personCount() {
    const personCount = this.$apiClient.$makeCaller(
      ...
      (c, lastNameStartsWith?: string | null) =>
        c.personCount(lastNameStartsWith),
  ...
  public get removePersonById() {
    ...
    Object.defineProperty(this, "removePersonById", {
      value: removePersonById,
    });
  ...
  public get namesStartingWith() {
    ...
    Object.defineProperty(this, "namesStartingWith", {
      value: namesStartingWith,
    });
  ...
  public get methodWithStringArrayParameter() {
    const methodWithStringArrayParameter = this.$apiClient.$makeCaller(
      ...
      (c, strings: string[] | null) =>
        c.methodWithStringArrayParameter(strings),
      () => ({ strings: null as string[] | null }),
      (c, args) => c.methodWithStringArrayParameter(args.strings)
    );

    Object.defineProperty(this, "methodWithStringArrayParameter", {
      value: methodWithStringArrayParameter,
    });
  ...
  public get methodWithEntityParameter() {
    const methodWithEntityParameter = this.$apiClient.$makeCaller(
      ...
      (c, person: $models.Person | null, people: $models.Person[] | null) =>
        c.methodWithEntityParameter(person, people),
      () => ({
        person: null as $models.Person | null,
        people: null as $models.Person[] | null,
      }),
      (c, args) => c.methodWithEntityParameter(args.person, args.people)
    );

    Object.defineProperty(this, "methodWithEntityParameter", {
      value: methodWithEntityParameter,
    });
  ...
  public get methodWithOptionalEntityParameter() {
    const methodWithOptionalEntityParameter = this.$apiClient.$makeCaller(
      ...
      (c, person?: $models.Person | null) =>
        c.methodWithOptionalEntityParameter(person),
      () => ({ person: null as $models.Person | null }),
      (c, args) => c.methodWithOptionalEntityParameter(args.person)
    );

    Object.defineProperty(this, "methodWithOptionalEntityParameter", {
      value: methodWithOptionalEntityParameter,
    });
  ...
  public get methodWithExplicitlyInjectedDataSource() {
    ...
    Object.defineProperty(this, "methodWithExplicitlyInjectedDataSource", {
      value: methodWithExplicitlyInjectedDataSource,
    });
  ...
  public get searchPeople() {
    const searchPeople = this.$apiClient.$makeCaller(
      ...
      (c, criteria: $models.PersonCriteria | null, page?: number | null) =>
        c.searchPeople(criteria, page),
      () => ({
        criteria: null as $models.PersonCriteria | null,
...
export class ProductViewModel
  extends ViewModel<$models.Product, $apiClients.ProductApiClient, number>
  implements $models.Product
{
...
export class ProductListViewModel extends ListViewModel<
  $models.Product,
  $apiClients.ProductApiClient,
  ProductViewModel
> {
  constructor() {
...
export interface StandaloneReadCreateViewModel
  extends $models.StandaloneReadCreate {
  id: number | null;
  name: string | null;
  date: Date | null;
}
export class StandaloneReadCreateViewModel
  extends ViewModel<
    $models.StandaloneReadCreate,
    $apiClients.StandaloneReadCreateApiClient,
    number
  >
  implements $models.StandaloneReadCreate
{
  ...
  constructor(initialData?: DeepPartial<$models.StandaloneReadCreate> | null) {
    super(
      $metadata.StandaloneReadCreate,
      new $apiClients.StandaloneReadCreateApiClient(),
      initialData
    );
  }
}
...
export class StandaloneReadCreateListViewModel extends ListViewModel<
  $models.StandaloneReadCreate,
  $apiClients.StandaloneReadCreateApiClient,
  StandaloneReadCreateViewModel
> {
  static DataSources = $models.StandaloneReadCreate.DataSources;
...
export interface StandaloneReadonlyViewModel
  extends $models.StandaloneReadonly {
  id: number | null;
  name: string | null;
  description: string | null;
}
export class StandaloneReadonlyViewModel
  extends ViewModel<
    $models.StandaloneReadonly,
    $apiClients.StandaloneReadonlyApiClient,
    number
  >
  implements $models.StandaloneReadonly
{
  ...
  constructor(initialData?: DeepPartial<$models.StandaloneReadonly> | null) {
    super(
      $metadata.StandaloneReadonly,
      new $apiClients.StandaloneReadonlyApiClient(),
      initialData
    );
  }
}
...
export class StandaloneReadonlyListViewModel extends ListViewModel<
  $models.StandaloneReadonly,
  $apiClients.StandaloneReadonlyApiClient,
  StandaloneReadonlyViewModel
> {
  static DataSources = $models.StandaloneReadonly.DataSources;
...
export interface StandaloneReadWriteViewModel
  extends $models.StandaloneReadWrite {
  id: number | null;
  name: string | null;
  date: Date | null;
}
export class StandaloneReadWriteViewModel
  extends ViewModel<
    $models.StandaloneReadWrite,
    $apiClients.StandaloneReadWriteApiClient,
    number
  >
  implements $models.StandaloneReadWrite
{
  ...
  constructor(initialData?: DeepPartial<$models.StandaloneReadWrite> | null) {
    super(
      $metadata.StandaloneReadWrite,
      new $apiClients.StandaloneReadWriteApiClient(),
      initialData
    );
  }
}
...
export class StandaloneReadWriteListViewModel extends ListViewModel<
  $models.StandaloneReadWrite,
  $apiClients.StandaloneReadWriteApiClient,
  StandaloneReadWriteViewModel
> {
  static DataSources = $models.StandaloneReadWrite.DataSources;
...
export class ZipCodeViewModel
  extends ViewModel<$models.ZipCode, $apiClients.ZipCodeApiClient, string>
  implements $models.ZipCode
{
...
export class ZipCodeListViewModel extends ListViewModel<
  $models.ZipCode,
  $apiClients.ZipCodeApiClient,
  ZipCodeViewModel
> {
  constructor() {
...
export class WeatherServiceViewModel extends ServiceViewModel<
  typeof $metadata.WeatherService,
  $apiClients.WeatherServiceApiClient
> {
  public get getWeather() {
    const getWeather = this.$apiClient.$makeCaller(
      ...
      (
        ...
        dateTime?: Date | null,
        conditions?: $models.SkyConditions | null
      ) => c.getWeather(location, dateTime, conditions),
      () => ({
        location: null as $models.Location | null,
        dateTime: null as Date | null,
        conditions: null as $models.SkyConditions | null,
      }),
