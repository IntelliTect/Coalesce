...
[Authorize]
    ...
    : LocalBaseApiController<Coalesce.Domain.CaseProduct, CaseProductDtoGen>
        ...
        [HttpPost("save")]
        [Authorize]
        public virtual SaveResult<CaseProductDtoGen> Save(CaseProductDtoGen dto, string includes = null, string dataSource = null, bool returnObject = true)
        {
        ...
        [HttpPost("CsvUpload")]
        [Authorize]
        public virtual async Task<IEnumerable<SaveResult<CaseProductDtoGen>>> CsvUpload(List<Microsoft.AspNetCore.Http.IFormFile> files, bool hasHeader = true) 
        {
