...
namespace Coalesce.Web.Api
{
        ...
        : BaseApiController<Coalesce.Domain.CaseProduct, CaseProductDtoGen, Coalesce.Domain.AppDbContext>
    {
        ...
        [HttpGet("get/{id}")]
        [Authorize]
        public virtual Task<ItemResult<CaseProductDtoGen>> Get(int id, DataSourceParameters parameters, IDataSource<Coalesce.Domain.CaseProduct> dataSource)
        ...
        [HttpPost("delete/{id}")]
        [Authorize]
        public virtual Task<ItemResult> Delete(int id, IBehaviors<Coalesce.Domain.CaseProduct> behaviors, IDataSource<Coalesce.Domain.CaseProduct> dataSource)
