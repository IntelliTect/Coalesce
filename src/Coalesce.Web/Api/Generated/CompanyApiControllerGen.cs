...
[Authorize]        public virtual bool Delete(string id)
        ...
        [HttpPost("save")]
[Authorize]        public virtual SaveResult<Company> Save(Company dto, string includes = null, bool returnObject = true)
        {
            return SaveImplementation(dto, includes, returnObject);
        }
        [HttpPost("AddToCollection")]
[Authorize]        public virtual SaveResult<Company> AddToCollection(int id, string propertyName, int childId)
        {
            return ChangeCollection(id, propertyName, childId, "Add");
        }
        [HttpPost("RemoveFromCollection")]
[Authorize]        public virtual SaveResult<Company> RemoveFromCollection(int id, string propertyName, int childId)
        {
