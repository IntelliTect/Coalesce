...
module TestArea.ListViewModels {
    ...
    export class CaseList {
        ...
        public items: KnockoutObservableArray<TestArea.ViewModels.Case> = ko.observableArray([]);
        // Load the list.
		public load: (callback?: any) => void;
        // Deletes an item.
		public deleteItem: (item: TestArea.ViewModels.Case) => void;
        ...
        constructor() {
            ...
            self.deleteItem = function(item: TestArea.ViewModels.Case)
            {
                item.deleteItem();
            };
