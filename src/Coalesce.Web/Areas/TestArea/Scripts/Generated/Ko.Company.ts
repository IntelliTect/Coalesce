...
module TestArea.ViewModels {
	...
	export class Company
    {
        ...
        public addToEmployees: () => void;
        // List Object model for Employees. Allows for loading subsets of data.
        public employeesList: () => TestArea.ListViewModels.PersonList;
        ...
        constructor(newItem?: any, parent?: any){
            ...
            // List Object model for Employees. Allows for loading subsets of data.
            var _employeesList: TestArea.ListViewModels.PersonList = null;
            self.employeesList = function() {
                if (!_employeesList){
                    _employeesList = new TestArea.ListViewModels.PersonList();
                    loadEmployeesList();
