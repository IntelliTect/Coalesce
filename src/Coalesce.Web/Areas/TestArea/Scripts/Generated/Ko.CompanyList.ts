...
module TestArea.ListViewModels {
    ...
    export class CompanyList {
        ...
        public items: KnockoutObservableArray<TestArea.ViewModels.Company> = ko.observableArray([]);
        // Load the list.
		public load: (callback?: any) => void;
        // Deletes an item.
		public deleteItem: (item: TestArea.ViewModels.Company) => void;
        ...
        // Valid values
            ...
            self.load = function(callback?: any) {
                ...
                var url = areaUrl + "api/Company/" + urlMethod + "?includes=" + self.includes + "&page=" + self.page()
                            + "&pageSize=" + self.pageSize() + "&search=" + self.search()
                            + "&listDataSource=" + CompanyDataSources[self.listDataSource];
                ...
                .done(function(data) {
                    ...
                    for (var i in data.list) {
                        var model = new TestArea.ViewModels.Company(data.list[i]);
            ...
            self.deleteItem = function(item: TestArea.ViewModels.Company)
            {
                item.deleteItem();
            };
