...
module TestArea.ListViewModels {
    ...
    export class DevTeamList {
        ...
        public items: KnockoutObservableArray<TestArea.ViewModels.DevTeam> = ko.observableArray([]);
        // Load the list.
		public load: (callback?: any) => void;
        // Deletes an item.
		public deleteItem: (item: TestArea.ViewModels.DevTeam) => void;
        ...
        // Valid values
            ...
            self.load = function(callback?: any) {
                ...
                var url = areaUrl + "api/DevTeam/" + urlMethod + "?includes=" + self.includes + "&page=" + self.page()
                            + "&pageSize=" + self.pageSize() + "&search=" + self.search()
                            + "&listDataSource=" + DevTeamDataSources[self.listDataSource];
            ...
            self.deleteItem = function(item: TestArea.ViewModels.DevTeam)
            {
                item.deleteItem();
            };
