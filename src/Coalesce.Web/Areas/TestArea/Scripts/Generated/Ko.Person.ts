...
module TestArea.ViewModels {
	...
	export class Person
    {
        ...
        public casesAssignedList: () => TestArea.ListViewModels.CaseList;
        ...
        public casesReportedList: () => TestArea.ListViewModels.CaseList;
        ...
        constructor(newItem?: any, parent?: any){
            ...
            // SetupValidation {
			self.firstName = self.firstName.extend({ minLength: { params: 2  } });
			self.firstName = self.firstName.extend({ minLength: { params: 2  } });
			self.lastName = self.lastName.extend({ minLength: { params: 3  } });
			self.lastName = self.lastName.extend({ minLength: { params: 3  } });
            ...
            // List Object model for CasesAssigned. Allows for loading subsets of data.
            var _casesAssignedList: TestArea.ListViewModels.CaseList = null;
            self.casesAssignedList = function() {
                if (!_casesAssignedList){
                    _casesAssignedList = new TestArea.ListViewModels.CaseList();
            ...
            // List Object model for CasesReported. Allows for loading subsets of data.
            var _casesReportedList: TestArea.ListViewModels.CaseList = null;
            self.casesReportedList = function() {
                if (!_casesReportedList){
                    _casesReportedList = new TestArea.ListViewModels.CaseList();
