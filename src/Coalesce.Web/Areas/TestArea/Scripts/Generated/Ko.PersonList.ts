...
module TestArea.ListViewModels {
    ...
    export class PersonList {
        ...
        public items: KnockoutObservableArray<TestArea.ViewModels.Person> = ko.observableArray([]);
        // Load the list.
		public load: (callback?: any) => void;
        // Deletes an item.
		public deleteItem: (item: TestArea.ViewModels.Person) => void;
        ...
        constructor() {
            ...
            self.load = function(callback?: any) {
                ...
                var url = areaUrl + "api/Person/" + urlMethod + "?includes=" + self.includes + "&page=" + self.page()
                            + "&pageSize=" + self.pageSize() + "&search=" + self.search()
                            + "&listDataSource=" + PersonDataSources[self.listDataSource];
                ...
                .done(function(data) {
                    ...
                    for (var i in data.list) {
                        var model = new TestArea.ViewModels.Person(data.list[i]);
            ...
            self.deleteItem = function(item: TestArea.ViewModels.Person)
            {
                item.deleteItem();
            };
