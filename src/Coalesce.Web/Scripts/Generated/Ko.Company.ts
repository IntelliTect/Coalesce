        ...
        constructor(newItem?: any, parent?: any){
			...
			self.save = function(callback?: any) {
				if (!self.isLoading()) {
					if (self.validate()) {
                        ...
                        var url = areaUrl + "api/Company/Save?includes=" + self.includes + '&dataSource=';
                        if (typeof self.dataSource === "string") url += self.dataSource;
                        else url += ListViewModels.CompanyDataSources[self.dataSource];
			...
			self.load = function(id: any, callback?) {
                ...
                if (id) {
                    ...
                    var url = areaUrl + "api/Company/Get/" + id + '?includes=' + self.includes + '&dataSource=';
                    if (typeof self.dataSource === "string") url += self.dataSource;
                    else url += ListViewModels.CompanyDataSources[self.dataSource];
