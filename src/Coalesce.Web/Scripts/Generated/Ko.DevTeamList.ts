...
module ListViewModels {
    ...
    export class DevTeamList {
        ...
        public items: KnockoutObservableArray<ViewModels.DevTeam> = ko.observableArray([]);
        // Load the list.
		public load: (callback?: any) => void;
        // Adds a new item to the collection.
		public addNewItem: () => ViewModels.DevTeam;
        // Deletes an item.
		public deleteItem: (item: ViewModels.DevTeam) => void;
        ...
        // Valid values
            ...
            self.load = function(callback?: any) {
                ...
                var url = areaUrl + "api/DevTeam/List?includes=" + self.includes + "&page=" + self.page()
                ...
                else url += DevTeamDataSources[self.listDataSource];
                ...
                .fail(function(xhr) {
                    ...
                    alert("Could not get list of DevTeam items: " + errorMsg);
                })
                .always(function() {
            ...
            self.getCount = function(callback?: any) {
                ...
                $.ajax({ method: "GET",
                         url: areaUrl + "api/DevTeam/count?" + "listDataSource=" + DevTeamDataSources[self.listDataSource] + "&" + self.queryString,
                         xhrFields: { withCredentials: true } })
                .done(function(data) {
                    self.count(data);
                ...
                .fail(function() {
                    alert("Could not get count of DevTeam items.");
                })
                .always(function() {
                    intellitect.utilities.hideBusy();
                });
            ...
            {
                var item = new ViewModels.DevTeam();
                self.items.push(item);
                return item;
            };

            // Deletes an item and removes it from the array.
            self.deleteItem = function(item: ViewModels.DevTeam)
            {
                item.deleteItem();
            };
