...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(EditAttributePermissionLevelCodeFixProvider)), Shared]
    public class EditAttributePermissionLevelCodeFixProvider : CodeFixProvider
    {
        public sealed override ImmutableArray<string> FixableDiagnosticIds =>
            ImmutableArray.Create(EditAttributePermissionLevelAnalyzer.Rule.Id);
        ...
        public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            var action = CodeAction.Create(
                title: "Remove PermissionLevel from EditAttribute",
                createChangedDocument: c => RemovePermissionLevelArgument(context.Document, attributeNode, c),
                equivalenceKey: "RemovePermissionLevelFromEditAttribute");
