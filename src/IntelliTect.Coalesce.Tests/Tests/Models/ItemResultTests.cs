...
namespace IntelliTect.Coalesce.Tests.Tests.Models
{
    public class ItemResultTests
    {
        ...
        [Fact]
        public void FromValidation_ForGenDto_WhenPkIsReferenceTypeIdentity_DoesNotProduceError()
        {
            // Precondition:
            var prop = ReflectionRepository.Global.GetClassViewModel<StringIdentity>().PrimaryKey;
            Assert.True(prop.Type.IsReferenceType);
            Assert.True(prop.IsAutoGeneratedPrimaryKey);
        ...
        [Fact]
        public void FromValidation_ForGenDto_DoesNotRequireNavigations()
        {
            // Precondition:
            ...
            })
            {
                ...
                Assert.True(prop.Role is PropertyRole.ReferenceNavigation or PropertyRole.CollectionNavigation);
            }
