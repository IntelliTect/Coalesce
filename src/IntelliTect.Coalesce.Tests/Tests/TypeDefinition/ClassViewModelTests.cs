...
namespace IntelliTect.Coalesce.Tests.TypeDefinition
{
    public class ClassViewModelTests
    {
        ...
        [Theory]
        [ClassViewModelData(typeof(EnumPk))]
        public void EnumPk_HasCorrectRulesAndProps(ClassViewModelData data)
        {
            var prop = data.ClassViewModel.PropertyByName(nameof(EnumPk.EnumPkId));
