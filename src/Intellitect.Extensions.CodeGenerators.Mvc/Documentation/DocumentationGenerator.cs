...
namespace Intellitect.Extensions.CodeGenerators.Mvc.Documentation
{
    ...
    public class DocumentationGenerator : CommonGeneratorBase
    {
        ...
        private void ParseAttributes(DocumentationViewModel viewModel)
        {
            ...
            foreach (ModelType modelType in ModelTypesLocator.GetAllTypes().Where(t => t.FullName.StartsWith("Intellitect.ComponentModel") && t.TypeSymbol.BaseType != null && t.TypeSymbol.BaseType.Name == "Attribute"))
            {
        ...
        private void ParseInterfaces(DocumentationViewModel viewModel)
        {
            ...
            foreach (ModelType modelType in ModelTypesLocator.GetAllTypes().Where(t => t.FullName.StartsWith("Intellitect.ComponentModel") && t.TypeSymbol.TypeKind == TypeKind.Interface))
            {
        ...
        private void ParseBaseControllers(DocumentationViewModel viewModel)
        {
            ...
            foreach (ModelType modelType in ModelTypesLocator.GetAllTypes().Where(t => t.FullName.StartsWith("Intellitect.ComponentModel.Controllers")))
            {
        ...
        private void ParseModels(DocumentationViewModel viewModel)
        {
            ...
            foreach (ModelType modelType in ModelTypesLocator.GetAllTypes().Where(t => t.FullName.StartsWith("Intellitect.ComponentModel.Models")))
            {
