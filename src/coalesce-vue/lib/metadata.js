...
exports.getEnumMeta = getEnumMeta;
function resolvePropMeta(metadata, propOrString, slient) {
...
exports.resolvePropMeta = resolvePropMeta;
function isClassType(prop) {
