...
export const ComplexModel = domain.types.ComplexModel = {
  ...
  methods: {
    ...
    downloadAttachment_CustomCache: {
      name: "downloadAttachment_CustomCache",
      displayName: "Download Attachment _ Custom Cache",
      transportType: "item",
      httpMethod: "GET",
      params: {
        id: {
...
export const Person = domain.types.Person = {
  ...
  dataSources: {
    ...
    parameterTestsSourceSubclass: {
      type: "dataSource",
      name: "ParameterTestsSourceSubclass" as const,
      displayName: "Parameter Tests Source Subclass",
      props: {
        personCriterion: {
          name: "personCriterion",
          displayName: "Person Criterion",
